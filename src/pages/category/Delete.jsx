...
const Delete = ({ isOpen, onClose, categoryId, onDelete }) => {
          ...
          <div className="flex items-center space-x-3">
            ...
            <div>
              <h3 className="text-lg font-medium text-gray-900">
                Delete Category
                <p className="text-sm text-gray-500">Category ID: {categoryId}</p>
              </h3>
            </div>
          </div>
          <button
          ...
          <div className="bg-yellow-50 border border-yellow-200 rounded-md p-3 mb-4">
            <div className="flex">
              ...
              <div className="text-sm text-yellow-700">
                <strong>Warning:</strong> This will permanently delete the category and cannot be recovered.
              </div>
            </div>
          </div>
        </div>
